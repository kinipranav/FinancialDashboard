...
for (i in 1:length(symbols)) {
	...
	write.xlsx(temp$IS$A,paste(tolower(symbols[i]),"_IS.xlsx",sep=""))
	write.xlsx(temp$BS$A,paste(tolower(symbols[i]),"_BS.xlsx",sep=""))
	write.xlsx(temp$CF$A,paste(tolower(symbols[i]),"_CF.xlsx",sep=""))
	}
